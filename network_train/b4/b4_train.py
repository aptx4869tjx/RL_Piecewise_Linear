...
if relu:
    pt_file0 = os.path.join(script_path, "b4-relu-actor" + str(hidden_layer) + "_" + str(hiden_size) + ".pt")
    pt_file1 = os.path.join(script_path, "b4-relu-critic" + str(hidden_layer) + "_" + str(hiden_size) + ".pt")
    pt_file2 = os.path.join(script_path, "b4-relu-actor-target" + str(hidden_layer) + "_" + str(hiden_size) + ".pt")
    pt_file3 = os.path.join(script_path, "b4-relu-critic-target" + str(hidden_layer) + "_" + str(hiden_size) + ".pt")
else:
    pt_file0 = os.path.join(script_path, "b4-actor" + str(hidden_layer) + "_" + str(hiden_size) + ".pt")
    pt_file1 = os.path.join(script_path, "b4-critic" + str(hidden_layer) + "_" + str(hiden_size) + ".pt")
    pt_file2 = os.path.join(script_path, "b4-actor-target" + str(hidden_layer) + "_" + str(hiden_size) + ".pt")
    pt_file3 = os.path.join(script_path, "b4-critic-target" + str(hidden_layer) + "_" + str(hiden_size) + ".pt")
...
if __name__ == "__main__":
    ...
    # np.save('./b4_Tanh_3_100_trace_list', arr=trace_list)
    start_time = time.time()
    repeat_list = reward_evaluate(agent, train_model, max_epi=60)
    np.save('./b4_train_reward', arr=repeat_list)
    ...
    # np.save('./b4_noisy_list' + str(noise_arr), arr=multiple_train_list)
    print('finished')
